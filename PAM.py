...
class PAM:
    def __init__(self, inito,n_cluster=2, max_iter=10, tol=0.1, start_prob=0.8, end_prob=0.99):
    ...
    def __initialize_medoids(self):
        ...
        elif self.initia=="random":
            self.medoids=np.random.choice(self.__rows-1, self.n_cluster, replace=False)
